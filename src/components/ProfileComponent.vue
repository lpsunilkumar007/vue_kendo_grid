<template>
  <div>
    <div v-if="user.id">
      <div class="row mb-4">
        ...
        <div class="col-sm text-sm-end">
          <KButton class="btn btn-secondary" @click="onSignOutClick"
            >Sign out</KButton
          >
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-7 k-card-list">
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="form-group">
                    <KLabel class="h6"> Username </KLabel>
                    <KInput :type="'text'" id="username" :value="user.login" />
                  </div>
                  <div class="form-group">
                    <KLabel class="h6"> Name </KLabel>
                  ...
                  <div class="form-group">
                    <KLabel class="form-check-label h6"> </KLabel>
                    <Checkbox :default-checked="true" /> Keep my email address
                    private
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <KButton class="btn btn-primary" @click="onUpdateClick"
                      >Update profile</KButton
                    >
                  </div>
                </div>
              </div>
          ...
          <Card id="delete-account">
            ...
            <CardBody>
              <p>
                You will immediately lose access to your repositories and all
                other information associated with your account.
                <strong>This cannot be undone!</strong>
              </p>
              <KButton class="btn btn-danger" @click="onDeleteClick"
                >Delete Account</KButton
              >
            </CardBody>
          </Card>
        </div>
        <div class="col-md-5 k-card-list">
          <Card id="notifications">
            ...
            <CardBody>
              ...
              <p class="text-muted">
                When you are given push access to a repository, automatically
          ...
          <Card id="password">
            ...
            <CardBody>
              <div class="form-group">
                <KLabel> Old password </KLabel>
                <KInput :type="'password'" :style="{ width: '100%' }" />
              </div>
              <div class="form-group">
                <KLabel> New password </KLabel>
                <KInput :type="'password'" />
              </div>
              <div class="form-group">
                <KLabel> Confirm password </KLabel>
                <KInput :type="'password'" />
              </div>
              <div class="form-group">
    ...
    <Dialog
      :modal="true"
      :title="'Thank You'"
      v-if="successWindowWidget"
      @close="onProfileDialogClose"
    >
    ...
    >
      ...
      <DialogActionsBar>
        <KButton @click="onDeleteDialogClose" style="width: 50%; float: left"
          >Cancel</KButton
        >
        <KButton
